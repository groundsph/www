...
export async function getAllCafes(
    ...
    if (filters.has_indoor_seating) query = query.eq("has_indoor_seating", true)
    if (filters.has_restroom) query = query.eq("has_restroom", true)
    if (filters.has_bidet) query = query.eq("has_bidet", true)
