            ...
            <div className='z-1 w-full h-full flex flex-col px-4 py-10 items-center text-background'>
                <div className='w-full max-w-7xl flex flex-col'>
                    ...
                    >
                        ...
                        {cafe.is_chain && (
                            <span
                                className='inline-flex items-center gap-1 px-2 py-1 bg-orange-500/30 text-orange-200 text-xs md:text-sm font-semibold rounded-full backdrop-blur-sm select-none'
                                title='Chain Cafe'
                            >
