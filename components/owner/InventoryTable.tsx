                    ...
                    <tbody className="divide-y divide-text/10">
                        {items.map((item) => (
                            ...
                            >
                                ...
                                <td className="px-4 py-3 text-center">
                                    <div className="relative inline-block" ref={openDropdownId === item.id ? dropdownRef : null}>
                                        <button
                                        ...
                                        {openDropdownId === item.id && (
                                            <div className="absolute right-0 top-full mt-1 w-44 bg-background border border-text/10 rounded-lg shadow-lg z-50 py-1">
                                                <button
                                                    onClick={() => {
                                                        onEdit(item)
                                                        setOpenDropdownId(null)
