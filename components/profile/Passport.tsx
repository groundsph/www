...
import { Coffee, Heart, MapPin, Stamp, Star, X } from "lucide-react"
...
export default function Passport({
    ...
    const [activeTab, setActiveTab] = useState<"visited" | "wishlist">(
        "visited"
    )
                            ...
                            {wishlist.length > 0 ? (
                                <div className='grid grid-cols-1 md:grid-cols-2 gap-3'>
                                    {wishlist.map((cafe) => (
                                        ...
                                        >
                                            <div className='w-10 h-10 rounded-lg bg-secondary/10 flex items-center justify-center text-secondary font-serif font-bold text-lg shrink-0'>
                                                {cafe.name.charAt(0)}
                                            </div>
                                            <Link
                                                href={`/cafes/${cafe.slug}`}
                                            ...
                                            {/* Placeholder for remove functionality if we add it later */}
                                            {/* {isOwnProfile && (
