...
// Also exclude membership_tier as it's no longer in the schema
export type CafeWithRatings = Omit<Tables<'cafes'>, 'operating_hours' | 'socials' | 'search_vector' | 'membership_tier'> & {
